...
<dd> <b>ISO 8855 - Glossary of Terms for Road Vehicle Dynamics and Road Holding Ability</b><br>
     ISBN 0-580-2083-03, 1991.
     </dd>
</dl>
<dl>
<dt>Society of Automotive Engineers:</dt>
<dd> <b>SAE J670e - Vehicle Dynamics Terminology</b><br>
     Society of Automotive Engineers, Inc., Warrendale, PA, July, 1976.
     </dd>
</dl>
</p><p>
</html>
    ...
    equation
      ...
      connect(RegularSea.y1, PlanarMotion.Heave)
        annotation (Line(points={{28.6,-58.2},{28,-58.2},{15.4,-58.2}},
                                                     color={0,0,127}));
      connect(RegularSea.y2, PlanarMotion.Pitch)
        annotation (Line(points={{28.6,-54},{15.4,-54}}, color={0,0,127}));
...
<img src=\"modelica://VesselEfficiency/images/Icons/Bridge.png\" width=\"200\" height=\"150\"><br>
  ...
  package Vessel "Necessary technical components"
    ...
    package Templates
      ...
      model SingleProp_3D "Single Propulsion with DXF"
        import VesselEfficiency;
        extends VesselEfficiency.Vessel.Interfaces.BaseVessel;
        replaceable VesselEfficiency.Vessel.Hull.Templates.SingleHull_3D
                                                             singleHull_3D
          constrainedby VesselEfficiency.Vessel.Hull.Interfaces.BaseSingleHull
          annotation (Placement(transformation(extent={{8,-20},{48,20}})));
        replaceable
        ...
        VesselEfficiency.Vessel.Hull.HullDimension.Templates.HullDimension
          hullDimension
          annotation (Placement(transformation(extent={{60,52},{100,92}})));
        Modelica.Icons.SignalBus VesselBus
          annotation (Placement(transformation(extent={{-20,80},{20,120}}),
              iconTransformation(extent={{-20,78},{20,118}})));
        Modelica.Blocks.Interfaces.RealInput wp "wind pressure" annotation (
            Placement(transformation(extent={{140,-40},{100,-80}}),
              iconTransformation(extent={{120,-60},{100,-80}})));
        Modelica.Mechanics.MultiBody.Interfaces.Frame_a planar_motion
          "connection to the planar motion"                                                             annotation(Placement(visible = true, transformation(origin = {0, -100}, extent = {{-16, -16}, {16, 16}}, rotation = 90), iconTransformation(origin={0,-102},    extent = {{-16, -16}, {16, 16}}, rotation = 90)));
      equation
        connect(SinglePropulsionSystem.frame_a, planar_motion) annotation (Line(
            points={{-80,-20},{-80,-40},{0,-40},{0,-100}},
            color={95,95,95},
            thickness=0.5));
        connect(singleHull_3D.frame_planar, planar_motion) annotation (Line(
            points={{28,-20.4},{28,-40},{0,-40},{0,-100}},
            color={95,95,95},
            thickness=0.5));
        connect(singleSteering.SteeringBus, VesselBus) annotation (Line(
            points={{-26,20},{-28,20},{-28,40},{0,40},{0,100}},
            color={255,204,51},
            thickness=0.5), Text(
            string="%second",
            index=1,
            extent={{6,3},{6,3}}));
        connect(SinglePropulsionSystem.PropulsionBus, VesselBus) annotation (
            Line(
            points={{-80,20},{-80,40},{0,40},{0,100}},
            color={255,204,51},
            thickness=0.5), Text(
            ...
            index=1,
            extent={{6,3},{6,3}}));
        connect(SinglePropulsionSystem.transmission, singleSteering.transmission)
          annotation (Line(points={{-60,0},{-48,0}}, color={0,0,0}));
        connect(singleHull_3D.frame_steering, singleSteering.frame_hull)
          annotation (Line(
            points={{8,0},{8,0},{-8,0}},
            color={95,95,95},
            thickness=0.5));
        connect(hullResistance.frame_resistance, singleHull_3D.frame_resistance)
          annotation (Line(
            points={{60,0},{54,0},{48,0}},
            color={95,95,95},
            thickness=0.5));
        connect(hullResistance.wp, wp) annotation (Line(points={{94,-22.4},{94,
                -60},{120,-60}}, color={0,0,127}));
        connect(hullDimension.H_air, hullResistance.H_air) annotation (Line(
              points={{66,49.6},{66,49.6},{66,22}}, color={0,0,127}));
        connect(hullDimension.B, hullResistance.B) annotation (Line(points={{74,49.6},
                {74,49.6},{74,22}},       color={0,0,127}));
        connect(singleHull_3D.HullBus, VesselBus) annotation (Line(
            points={{28,20},{28,40},{0,40},{0,100}},
            color={255,204,51},
            thickness=0.5));
        connect(hullResistance.ResistanceBus, VesselBus) annotation (Line(
        ...
        annotation(Diagram(coordinateSystem(preserveAspectRatio=false,   extent={{-100,
                  -100},{100,100}})),                                                                           Icon(coordinateSystem(preserveAspectRatio = false, extent={{-100,
                  -100},{100,100}}), graphics={                                                                                                    Text(origin={
                    -3.37177,-135.447},                                                                                       lineColor=
                    {244,125,35},                                                                                                    extent={{
                    -80.6282,77.4492},{85.3718,43.447}},
                textString="Single Propulsion with DXF")}));
      end SingleProp_3D;
    end Templates;
      ...
      package Templates
        ...
        model TwinSteeringSystem "Twin steering"
          ...
          PropulsorDimension.Templates.PropulsorDimension propulsorDimension
            annotation (Placement(transformation(extent={{-64,44},{-28,78}})));
        equation

          connect(flange_a, propForces.flange_a) annotation (Line(points={{-100,0},{-72,
                  0},{-72,20.78},{-42,20.78}},   color={0,0,0}));
          connect(propForces1.flange_a, propForces.flange_a) annotation (Line(
                points={{-42,-42.24},{-72,-42.24},{-72,20.78},{-42,20.78}},
                                                                color={0,0,0}));
      ...
      package Templates
        ...
        model SingleHull "Single Hull"
          ...
          Modelica.Mechanics.MultiBody.Parts.Body body(r_CM = {0, 0, 0.5}, I_11 = 10, I_22 = 10, I_33 = 100,
            animation=true,
            m=200)                                                                                                     annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin={10,30})));
          ...
          Modelica.Mechanics.MultiBody.Parts.Body body1(
            ...
            animation=true,
            m=10)                                                                                                     annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin={80,30})));
          Modelica.Mechanics.MultiBody.Parts.Body body2(
                                                       r_CM = {0, 0, 0.5}, I_11 = 10, I_22 = 10, I_33 = 100,
            animation=true,
            m=500)                                                                                                     annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}, rotation = 90, origin={-90,30})));
          ...
          Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedTranslation1(
            ...
            r={0,0,0})                                                                                                     annotation(Placement(transformation(extent={{-10,-10},
                ...
                origin={-10,14})));
        equation
          connect(body.frame_a, fore.frame_a) annotation(Line(points={{10,20},{
                  10,12},{10,0},{24,0}},                                                           color = {95, 95, 95}, thickness = 0.5));
          ...
          connect(velocity.Total_velocity, HullBus.CurrentVelocity) annotation (
             Line(points={{-19,70},{-19,70},{0,70},{0,100}}, color={0,0,127}),
              Text(
              string="%second",
              index=1,
              extent={{6,3},{6,3}}));
          connect(velocity.Y_velocity, VelocityY.v[2]) annotation (Line(points={{-42,64},
                  {-50,64},{-50,55}},           color={0,0,127}));
          connect(velocity.X_velocity, VelocityX.v[1]) annotation (Line(points={{-42,76},
                  {-69.3333,76},{-69.3333,55}},           color={0,0,127}));
          ...
          connect(absoluteAngles.frame_a, frame_resistance) annotation (Line(
              points={{50,50},{50,0},{100,0}},
              color={95,95,95},
              thickness=0.5));
          connect(absoluteAngles.angles[3], HullBus.ShipPosition) annotation (
              Line(points={{49.3333,71},{49.3333,80},{0,80},{0,100}}, color={0,
                  0,127}), Text(
              string="%second",
              index=1,
              extent={{6,3},{6,3}}));
          ...
          connect(VelocityY.frame_a, fixedTranslation1.frame_a) annotation (
              Line(
              points={{-50,34},{-50,34},{-50,32},{-10,32},{-10,24}},
              color={95,95,95},
              thickness=0.5));
          connect(VelocityX.frame_a, fixedTranslation1.frame_a) annotation (
              Line(
              points={{-70,34},{-70,28},{-10,28},{-10,24}},
              color={95,95,95},
              thickness=0.5));
 ...
 <hr>
  ...
  package Motion "Definitions of vessel motion"
    ...
    model PlanarMotion
      ...
      Modelica.Mechanics.MultiBody.Joints.Planar planar annotation(Placement(transformation(extent={{-60,-80},
                {-40,-60}})));
      ...
      Modelica.Mechanics.MultiBody.Interfaces.Frame_b worldFrame annotation(Placement(visible = true, transformation(origin={-100,0},    extent = {{-16, -16}, {16, 16}}, rotation = 0), iconTransformation(origin={-100,0},    extent = {{-16, -16}, {16, 16}}, rotation = 0)));
    ...
    equation
      connect(planar.frame_b, heave.frame_a) annotation (Line(
          points={{-40,-70},{0,-70},{0,-52}},
          color={95,95,95},
          thickness=0.5));
      connect(planar.frame_a, worldFrame) annotation (Line(
          points={{-60,-70},{-80,-70},{-80,-66},{-80,0},{-100,0}},
          color={95,95,95},
          thickness=0.5));
...
<p>Standard package icon.</p>
    ...
    partial package HullPackage
      extends Package;
      annotation(Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics={  Line(points = {{-78, 30}, {82, 30}, {42, -30}, {-38, -30}, {-78, 30}}, color = {0, 0, 0})}));
    end HullPackage;
